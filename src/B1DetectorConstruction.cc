...
G4VPhysicalVolume* B1DetectorConstruction::Construct()
{
  ...
  //G4Material* env_mat = nist->FindOrBuildMaterial("G4_Ni");
  G4Material* env_mat = new G4Material("Nickel", 28, 58.934*g/mole, 8.902*g/cm3);
  ...
  //logicEnv->SetVisAttributes(new G4VisAttributes(G4Colour(1,0,0)));
